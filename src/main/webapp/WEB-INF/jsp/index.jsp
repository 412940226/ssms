			...
			<div class="container-fluid">
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<span class="username">当前用户是${authUserInfo }</span>
						...
						<ul class="dropdown-menu">
							...
							<li><a href=<c:url value='/logout'/>><i class="icon-key"></i> 系统退出</a></li>
				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							...
							<a href=<c:url value='/sys/user/list'/>>
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="static/media/image/loading.gif" alt="loading" />
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="static/media/image/avatar.png" />
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										...
										<ul class="chats">
											...
											<li class="in">
												...
												<img class="avatar" alt="" src="static/media/image/avatar1.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="static/media/image/avatar2.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="static/media/image/avatar3.jpg" />
